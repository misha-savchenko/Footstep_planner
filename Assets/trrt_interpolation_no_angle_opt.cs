...
public class trrt_interpolation_no_angle_opt : MonoBehaviour
{
    ...
    Vector2 Interpolate(Vector2 close_location, Vector2 random_location)
    {
        ...
        while(Vector2.Distance(close_location,mid_location) < Vector2.Distance(close_location,final_location))
        {
            ...
            if (getCost(getPoint(temp_mid_location[0] / x_max, temp_mid_location[1] / y_max),d)>= 0.8)
            {
                ...
                /*
                Debug.Log("INTER FAIL");
                Debug.Log(close_location);
                Debug.Log(mid_location);
                Debug.Log(getPoint(mid_location[0] / x_max, mid_location[1] / y_max));
                Debug.Log(getH(getPoint(mid_location[0] / x_max, mid_location[1] / y_max),d));
                Debug.Log(random_location);
                */
                break;
            }
            else
